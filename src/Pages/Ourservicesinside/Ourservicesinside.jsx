  ...
  return (
    <div className="Ourservicesinside">
      ...
      <defs>
        ...
        <div className="Ourservicesinside-page3-end">LEARN MORE
      ...
      <div className="Ourservicesinside-page4">
        ...
        <div className="Ourservicesinside-page4-main">
          ...
          {/* Change the content below for adding drop-down feature */}
          {/* <Disclosure>
            {({ open }) => (
                <div className={`group bg-light border-b border-dark transition-all ease-in-out duration-500 ${open ? 'bg-dark border-light' : ''}`}>
          <Disclosure.Button className="w-full flex items-center p-4 lg:p-6 justify-between !text-left" id="headlessui-disclosure-button" type="button">
            <h3 className={`lists-heading mb-4 lg:mb-6 !mb-0 !text-[24px] md:!text-[28px] lg:!text-[32px] transition-all ease-in-out duration-500 ${open ? 'text-light' : ''}`}>
              Media Planning
            </h3>
            <svg
              ...
              viewBox="0 0 65 64"
              fill="none"
              className="w-6 h-6 md:w-12 md:h-12 lg:w-16 lg:h-16 fill-dark transition-all ease-in-out duration-500"
            >
              <path d="M30.0853 13.9724C30.0853 12.9485 30.9153 12.1184 31.9393 12.1184C32.9632 12.1184 33.7932 12.9485 33.7932 13.9724L33.7932 50.0275C33.7932 51.0515 32.9632 51.8815 31.9393 51.8815C30.9153 51.8815 30.0853 51.0515 30.0853 50.0275L30.0853 13.9724Z" class="fill-dark origin-center group-data-[headlessui-state=open]:scale-0 transition-all ease-in-out duration-500"></path><path d="M49.9669 30.146C50.9908 30.146 51.8208 30.9761 51.8208 32C51.8208 33.0239 50.9908 33.854 49.9669 33.854L13.9117 33.854C12.8878 33.854 12.0577 33.0239 12.0577 32C12.0577 30.9761 12.8878 30.146 13.9117 30.146L49.9669 30.146Z"></path>
            </svg>
          </Disclosure.Button>
          <Disclosure.Panel className="transform transition-all ease-in-out duration-500" style={{ display: open ? 'block' : 'none' }}>
            <div className="mb-4 px-4 lg:mb-6 lg:px-6 transition-all ease-in-out duration-500">
              <p className='lists-content'>We also help you in Media Planning by Creating an elevated customer journey requires a broad perspective. We plan, buy, and optimize media using a multi-channel approach.</p>
            </div>
          </Disclosure.Panel>
        </div>
